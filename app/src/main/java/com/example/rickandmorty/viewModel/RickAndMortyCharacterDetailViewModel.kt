...
@HiltViewModel
class RickAndMortyCharacterDetailViewModel @Inject constructor(private val repository: DataRepository) :
    ViewModel() {
    ...
    fun loadEpisodes(character: ItemListData) {
        viewModelScope.launch {
            episodes.value =
                repository.getCharacterIncludedEpisodeDetails(getIncludedEpisodeList(character)).episodeList
        }
    }
